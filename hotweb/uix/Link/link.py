...
class Component:
    ...
    def __init__(self,to,component="a",**kwargs):
        self.kwargs = kwargs
        self.component =component
        self.has_closing = True
        self.current_component = f"<{self.component} href='{to}' "
...
a = Component("man.html",className="class test")
print(a.build_component())